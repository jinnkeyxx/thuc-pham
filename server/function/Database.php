...
class Database
{
    ...
    {
        $this->link = mysqli_connect("localhost","root","","thucpham") or die ("<h1 style='text-align: center; color : red; font-weight: bold'> connect database fail </h1>");
    ...
    {
        $sql = "SELECT * FROM {$table} WHERE 1 ORDER BY id " ;
